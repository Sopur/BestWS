void (function (exportObject, name) {
    // arrays.js
    {
        /**
         * All the TypedArray's BestWS encoder supports
         */
    ...
    {
        /**
         * Limit for each 8-32bits.
         * Used for size optimizations when writing ints.
         */
    ...
    {
        const { EncodeError, isTypedArray, isArrayBuffer } = util;
        ...
        var Writer = class Writer {
            ...
            write(data) {
                switch (typeof (data ?? undefined)) {
                    case "bigint": {
                        this.writer.u8 = types.I64;
                        this.writer.i64 = data;
                        break;
                    }
                    case "boolean": {
                        this.writer.u8 = types.BOOL_FALSE + data;
                        break;
                    }
                    case "number": {
                        if (isNaN(data) === true) {
                            this.writer.u8 = types.NULL;
                            break;
                        }
                        if (Number.isInteger(data) === false) {
                            this.writer.u8 = types.F64;
                            this.writer.f64 = data;
                            break;
                        }
                        if (data < 0) {
                            data = Math.abs(data);
                            if (data < limits.I8) {
                                this.writer.u8 = types.I8;
                                this.writer.i8 = data;
                            } else if (data < limits.I16) {
                                this.writer.u8 = types.I16;
                                this.writer.i16 = data;
                            } else if (data < limits.I32) {
                                this.writer.u8 = types.I32;
                            ...
                            if (data < limits.U8) {
                                this.writer.u8 = types.U8;
                                this.writer.u8 = data;
                            } else if (data < limits.U16) {
                                this.writer.u8 = types.U16;
                                this.writer.u16 = data;
                            } else if (data < limits.U32) {
                                this.writer.u8 = types.U32;
                                this.writer.u32 = data;
                            } else {
                                this.writer.u8 = types.U64;
                    ...
                    case "object": {
                        ...
                        if (isTypedArray(data)) data = data.buffer;
                        if (isArrayBuffer(data)) {
                            const view = new DataView(data);
                            let offset = 0;
                            this.writer.u8 = types.BUFFER;
                    ...
                    case "string": {
                        if (data.length <= 1) {
                            this.writer.u8 = types.CHARACTER;
                            this.writer.u8 = (data[0] ?? "\x00").charCodeAt();
                            break;
                        }
                        this.writer.u8 = types.STRING;
...

    {
        exportObject[name] = {
            ...
            Reader: Reader,
            raw: spb,
            TypedArrays: arrayTypes,
            Limits: limits,
        };
    }
})(typeof module === "undefined" ? window : module?.exports ?? window, "BWSE");
